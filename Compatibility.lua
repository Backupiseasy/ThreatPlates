...
local WOW_EVENTS = {
  ...
  BN_CONNECTED = Addon.ExpansionIsAtLeastCata,
  BN_FRIEND_ACCOUNT_OFFLINE = Addon.ExpansionIsAtLeastCata,
  BN_FRIEND_ACCOUNT_ONLINE = Addon.ExpansionIsAtLeastCata,
  ...
  PLAYER_EQUIPMENT_CHANGED = Addon.ExpansionIsAtLeastCata,
  ...
  RUNE_UPDATED = Addon.ExpansionIsAtLeastCata,
  ...
  UNIT_SPELLCAST_INTERRUPTIBLE = Addon.ExpansionIsAtLeastCata,
  UNIT_SPELLCAST_NOT_INTERRUPTIBLE = Addon.ExpansionIsAtLeastCata,

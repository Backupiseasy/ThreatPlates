...
* Fixed a Lua error when coloring nameplates of player-controlled units, caused by PvP status being a secret value for them [GH-744].
* Fixed the threat percentage not showing after /reload when "Show in Groups" is enabled, until the next group roster update [GH-737].

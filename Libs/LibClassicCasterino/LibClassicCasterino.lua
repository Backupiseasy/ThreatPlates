...
--function lib:PrintDebug()
--    for spell_id, cast_time_per_level in pairs(CastTimeByCharacterLevel) do
--        local name, rank, icon, castTime, minRange, maxRange, spellId = GetSpellInfo(spell_id)
--        print ("Spell:", name, "(" .. tostring(spell_id) .. ")")
--        for level, cast_time in pairs(cast_time_per_level) do
--            print ("    ", level, "=>", cast_time)
--        end
--    end
--end

...
L["Enemy Units"] = "敌方单位"
L["Everything"] = "全部"
L["Export current profile"] = "導出當前配置文件"
L["Export the current profile into text that can be pasted by another user"] = "将当前配置文件导出为可由其他用户粘贴的文本"
L["Faction Icon"] = "阵营图示"
L["Fading"] = "淡出"
...
L["Import a profile"] = "导入个人资料"
L["Import a profile from another user"] = "从其他用户导入配置文件"
L["Import and export profiles that can be shared with other players"] = "导入和导出可与其他玩家共享的配置文件"
...
L["Paste"] = "粘贴"
L["Pasted!"] = "已粘贴！"
L["Paste ThreatPlates profile string into the box and then close the window"] = "将配置文件字符串粘贴到框中，然后关闭窗口"
...
L["Social"] = "社交"
L["Something went wrong importing your profile, please check the import string"] = "导入个人资料时出错，请检查导入字符串"

...
L["Show Friendly Nameplates"] = "Solo mostrar placas de nombres de amistosos"
...
L["Show the Blizzard default nameplates for friendly units in instances."] = "Mostrar las placas de nombre por defecto de Blizzard para unidades amistosas en estancias."
...
L["The font for unit names can only be changed if nameplates and names are be enabled for these units. Names can be enabled in \"Game Menu - Interface - Names\"."] = "La fuente de los nombres de las unidades solo puede ser cambiada si las placas de nombre y nombres están habilitados para estas unidades. Los nombres pueden ser habilitados en \"Menú de juego - Interfaz - Nombres\"."

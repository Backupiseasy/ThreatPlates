...
L["|cff00ff00tanking|r"] = "|cff00ff00tanqueo|r"
...
L["|cff89F559Threat Plates|r: DPS switch detected, you are now in your |cffff0000dpsing / healing|r role."] = "|cff89F559Threat Plates|r: Cambio de DPS detectado, estás en rol de |cffff0000daño / sanación|r."
...
L["|cff89F559Threat Plates|r: Tank switch detected, you are now in your |cff00ff00tanking|r role."] = "|cff89F559Threat Plates|r: Cambio de tanque detectado, estás en rol de |cff00ff00tanqueo|r."
...
L["|cffff0000dpsing / healing|r"] = "|cffff0000daño / sanación|r"
...
L["|cffff0000IMPORTANT: Enabling this feature changes console variables (CVars) which will change the appearance of default Blizzard nameplates. Disabling this feature will reset these CVars to the original value they had when you enabled this feature.|r"] = "|cffff0000IMPORTANTE: Habilitar esta característica cambia las variables de la consola (CVars) que cambiarán la apariencia de las placas identificativas predeterminadas de Blizzard. Deshabilitar esta característica restablecerá estos \"CVars\" al valor original que tenían cuando habilitó esta función.|r"
L["|cffff0000Low Threat|r"] = "|cffff0000Baja Amenaza|r"
L["|cffFF0000The Auras widget must be enabled (see Widgets - Auras) to use auras as trigger for custom nameplates.|r"] = "|cffFF0000El artilugio Auras debe estar habilitado (ver Artilugios - Auras) para usar auras como activador de placas identificativas personalizadas.|r"
...
L["A custom nameplate with this trigger already exists: "] = "Ya existe una placa identificativa personalizada con este activador:"
...
L["All"] = "Todos"
L["All Minions"] = "Todos los esbirros"
...
L["Allow soft target selection while player has a locked target."] = "Permitir selección de objetivo dinámico mientras el jugador tenga un objetivo fijado."
L["Alpha"] = "Alfa"
L["Alpha multiplier of nameplates for occluded units."] = "Multiplicador de transparencia de placas identificativas para unidades ocluídas."
L["Always"] = "Siempre"
L["Always do action targeting"] = "Siempre hacer combate de acción"
L["Always do soft targeting"] = "Siempre hacer marcado dinámico"
--[[Translation missing --]]
...
L["Apply these custom settings to the nameplate of a unit with a particular name or NPC ID. You can add multiple entries separated by a semicolon. You can use use * as wildcard character in names."] = "Aplica esta configuración personalizada a la placa de nombre de una unidad con un nombre particular o ID de PNJ. Puedes agregar entradas múltiples separadas por un punto y coma. Puedes usar * como letra comodín en los nombres"
...
L["Artwork"] = "Arte"
L["Attempt to register script for unknown WoW event \"%s\""] = "Intentando registrar secuencia de comandos para evento de WoW desconocido \"%s\""
...
L["Auto-set Target"] = "Autoestablecer objetivo"
L["Auto-set target to match action target"] = "Autoestablecer objetivo para corresponder a combate de acción"
L["Auto-set target to match soft target"] = "Autoestablecer objetivo para corresponder objetivo dinámico"
L["Auto-set target to match soft target."] = "Autoestablecer objetivo para corresponder objetivo dinámico."
L["Background"] = "Fondo"
...
L["Bosses"] = "Jefes"
L["Both you and the other player are flagged for PvP."] = "Tanto usted como el otro jugador están marcados para JcJ"
L["Bottom"] = "Inferior"
...
L["Changing these settings will alter the placement of the nameplates, however the mouseover area does not follow. |cffff0000Use with caution!|r"] = "Cambiar esta configuración alterará la ubicación de las placas identificativas, sin embargo, el área del cursor por encima se mantiene. |cffff0000¡Utilicela con cuidado!|r"
...
L["Custom Enemy Status Text"] = "Texto de estado de enemigo personalizado"
L["Custom Friendly Status Text"] = "Texto de estado amigable personalizado"
...
L["CVar \"%s\" has an invalid value: \"%s\". The value must be a number. Using the default value for this CVar instead."] = "CVar \"%s\" tiene un valor inválido: \"%s\". El valor debe ser un número, Se usará el valor por defecto para esta CVar en su lugar."
L["CVar %s has an invalid value: %s. The value must be a number. Using the default value for this CVar instead."] = "CVar %s tiene un parámetro inválido: %s. El parámetro debe ser un número. Se usará el parámetro por defecto para esta CVar en su lugar."
L["Cyclic anchoring of aura areas to each other is not possible."] = "Anclaje cíclico de las áreas de aura una con otra no es posible."
L["Darnavan"] = "Darnavan"
...
L["Death Rune"] = "Runa de muerte"
L["Debuff Color"] = "Color de perjuicio"
L["Debuffs"] = "Perjuicios"
L["Debuffs on Friendly"] = "Perjuicios en amistoso"
...
L["Delete"] = "Quitar"
L["Delta Percentage"] = "Porcentaje Delta"
L["Delta Threat Value"] = "Valor Delta de amenaza"
...
L["Determine your role (tank/dps/healing) automatically based on current stance, form, aura, presence, or rune."] = "Determina tu rol (tanque, dps, sanador) automáticamente basado en tu actitud, forma, aura, presencia o runa actual. "
L["Disable"] = "Deshabilitar"
L["Disable threat scale for target marked, mouseover or casting units."] = "Deshabilitar la escala de amenaza para el objetivo marcado, con el cursor encima o unidades lanzando."
L["Disable threat transparency for target marked, mouseover or casting units."] = "Deshabilitar la transparencia de amenaza para el objetivo marcado, con el cursor encima o unidades lanzando."
...
L["DPS switch detected, you are now in your |cffff0000dpsing / healing|r role."] = "Cambio de DPS detectado, ahora estás en rol de |cffff0000daño / sanación|r."
...
L["Enable Experience Widget"] = "Habilitar el artilugio de experiencia"
L["Enable Focus Widget"] = "Habilitar el artilugio de enfoque"
...
L["Enable Target Highlight"] = "Habilitar resaltado de objetivo"
L["Enable Target Widget"] = "Habilitar el artilugio de objetivo"
...
L["Enemies"] = "Enemigos"
L["Enemy"] = "Enemigo"
L["Enemy Bar Height"] = "Altura de barra enemiga"
L["Enemy Bar Width"] = "Ancho de barra enemiga"
L["Enemy Casting"] = "Lanzamiento de Enemigo"
--[[Translation missing --]]
L["Enemy Healthbar Color"] = "Enemy Healthbar Color"
L["Enemy Height"] = "Altura de enemigo"
...
L["Enemy Width"] = "Ancho de enemigo"
...
L["Error executing icon texture function for %s:"] = "Error al ejecutar la función de textura de icono para %s:"
L["Error in custom style '%s': only numbers and strings are allowed as icon sources for function SetIcon."] = "Error en el estilo personalizado '%s': solo se permiten números y cadenas como fuentes de iconos para la función establecer ícono."
...
L["Everything"] = "Todos"
L["Evoker"] = "Evocador"
L["Evoker Essence Cooldown"] = "Enfriamiento de Esencias de Evocador"
...
L["Find a suitable icon based on the current trigger. For Unit triggers, the preview does not work. For multi-value triggers, the preview always is the icon of the first trigger entered."] = "Busca un icono adecuado basado en el desencadenante actual. Para unidades desencadenantes, la vista previa no funciona. Para desencadenantes de múltiples valores, la vista previa siempre será el icono del primer desencadenante ingresado."
L["Five"] = "Cinco"
--[[Translation missing --]]
...
L["Friend"] = "Amistoso"
L["Friend Bar Height"] = "Altura de barra aliada"
L["Friend Bar Width"] = "Ancho de barra aliada"
L["Friend Height"] = "Altura de aliado"
L["Friend Width"] = "Anchura de aliado"
...
L["Friendly PvP On"] = "JcJ amistoso encendido"
...
L["Function"] = "Función"
L["Game Object"] = "Objeto del Juego"
...
L["Hard locked target only"] = "Objetivo constante solamente"
...
L["Highlight for Expiring Icons"] = "Resaltado para iconos que caducan"
...
L["Hostile PvP On - Self Off"] = "JcJ Hostil Encendido - Autoapagado"
L["Hostile PvP On - Self On"] = "JcJ Hostil Encendido - Autoencendido"
...
L["Ignore PvP Status"] = "Ignorar estado de JcJ"
...
L["Illegal character used in Unit trigger at position: "] = "Carácter inválido usado en desencadenante de unidad en la posición:"
...
L["Interact"] = "Interactuar"
L["Interact Icon"] = "Ícono de interactuar"
...
L["Match appropriate action target to locked target."] = "Concordar combate en acción con objetivo fijado."
L["Match appropriate soft target to locked target."] = "Concordar objetivo dinámico con objetivo fijado."
...
L["Member 2"] = "Miembro 2"
L["Member 3"] = "Miembro 3"
L["Member 4"] = "Miembro 4"
L["Member 5"] = "Miembro 5"
L["Metric Unit Symbols"] = "Unidades Métricas"
L["Middle"] = "Centro"
...
L["Mouseover"] = "Con el cursor encima"
...
L["Nameplates"] = "Placas identificativas"
L["Names"] = "Nombres"
L["Neutral"] = "Neutral"
...
L["Never"] = "Nunca"
L["New"] = "Nuevo"
L["No matching"] = "Sin concordancia"
...
L["Only highlight expiring alerts with the selected priority."] = "Resalte solo las alertas que caducan con la prioridad seleccionada."
...
L["Percentage - Scaled"] = "Porcentaje - Escalado"
...
L["Please select a target unit with a nameplate to enable configuration mode."] = "Por favor, seleccione una unidad objetivo con barra identificativa para habilitar el modo de configuración."
L["Poison"] = "Veneno"
L["Position"] = "Posición"
...
L["Rogue"] = "Pícaro"
L["Role toggle not supported because automatic role detection is enabled."] = "Selección manual de función deshabilitada debido a que la detección automática de función está habilitada."
L["Roles"] = "Rol"
...
L["Scale"] = "Escala"
L["Scaled Percentage"] = "Porcentaje escalado"
L["Scaled Percentage Delta"] = "Delta de porcentaje escalado"
--[[Translation missing --]]
...
L["Show all debuffs on friendly units."] = "Muestra todos los perjuicios en aliados."
--[[Translation missing --]]
...
L["Show debuffs that where applied by bosses."] = "Mostrar perjuicios que fueron aplicados por los jefes."
...
L["Show Friendly Nameplates"] = "Solo mostrar placas identificativas aliadas"
...
L["Show friendly players' and totems' names in instances."] = "Mostrar nombres de jugadores amistosos y tótems en estancias."
...
L["Show icon for soft interact game objects (interactable objects you cannot normally target)."] = "Mostrar icono en las entidades interactuables del juego (entidades interactuables que no se pueden seleccionar normalmente)."
...
L["Show interact icons even when there is other visual indicators, such as quest or loot effects."] = "Mostar iconos de interacción, aun cuando hay otros indicadores visuales, como efectos de misión o despojar."
L["Show Level Text"] = "Mostrar Texto de Nivel"
L["Show Mouseover"] = "Mostrar con el cursor encima"
...
L["Show only unit names and hide healthbars (requires /reload). Note that the clickable area of friendly nameplates will also be set to zero so that they don't interfere with enemy nameplates stacking (not in Classic or TBC Classic)."] = "Mostrar solo nombres de unidades y oculta las barras de vida (requiere recargar). Toma en cuenta que el área cliqueable de las placas identificativas aliadas también serán establecidas en cero para que así no interfieran con el apilado de las placas identificativas enemigas. (No en Classic ni en TBC Classic)."
L["Show only unit names and hide nameplate bars (requires /reload). Note that the clickable area of friendly nameplates will also be set to zero so that they don't interfere with enemy nameplates stacking (not in Classic or TBC Classic)."] = "Mostrar solamente los nombres de las unidades y esconde las barras de placas identificativas (requiere \"/reload\"). Tenga en cuenta que el área cliqueable de las placas de nombre amistosas serán puestas en cero para que no interfieran con el apilado de las placas de nombre enemigas (no en WoW Classic ni TBC Classic)."
...
L["Show the Blizzard default nameplates for friendly units in instances."] = "Mostrar las placas identificativas predeterminadas de Blizzard para unidades aliadas en estancias."
...
L["Show the player's threat percentage (scaled or raw) or threat delta to the second player on the threat table (percentage or threat value) against the enemy unit."] = "Muestra el porcentaje de amenaza del jugador (escalado o en bruto) o el delta de amenaza con respecto al segundo jugador en la tabla de amenaza (porcentaje o valor) contra la unidad enemiga."
L["Show the player's threat percentage against the enemy unit relative to the threat of enemy unit's primary target."] = "Muestra el porcentaje de amenaza del jugador comparado con la amenaza del objetivo primario de la unidad enemiga."
...
L["Show the player's total threat value on the enemy unit."] = "Muestra el valor total de amenaza del jugador en la unidad enemiga."
...
L["Show unlimited buffs in combat."] = "Mostrar beneficios ilimitados en combate."
L["Show unlimited buffs in instances (e.g., dungeons or raids)."] = "Mostrar beneficios ilimitados en estancias (por ejemplo, mazmorras o bandas)."
L["Show unlimited buffs on bosses and rares."] = "Mostrar beneficios ilimitados en jefes y raros."
--[[Translation missing --]]
...
L["Social"] = "Social"
L["Soft Target"] = "Objetivo dinámico"
L["Soft Target Icon"] = "Icono de objetivo dinámico"
...
L["Swap Scale By Reaction"] = "Cambiar escala por la reacción"
...
L["Switch scale values for debuffs and buffs for friendly units."] = "Cambia valores de escala para perjuicios y beneficios para unidades aliadas."
L["Symbol"] = "Símbolo"
...
L["Tank"] = "Tanque"
L["Tank Scaled Percentage"] = "Porcentaje escalado del tanque"
L["Tank switch detected, you are now in your |cff00ff00tanking|r role."] = "Cambio de tanque detectado, ahora estás en rol de |cff00ff00tanqueo|r"
...
L["Target Locking"] = "Fijación de objetivos"
...
L["Target Style"] = "Estilo de objetivo"
...
L["Target's NPC ID"] = "ID de PNJ objetivo"
L["Targets you attack"] = "Objetivos que ataques"
...
L["The player is friendly to you, and flagged for PvP."] = "El jugador amistoso para ti y habilitado para JcJ."
L["The player is hostile, and flagged for PvP, but you are not."] = "El jugador es hostil y habilitado para JcJ, pero usted no."
...
L["These settings will define the space that text can be placed on the nameplate."] = "Estas opciones van a definir el espacio habilitado para texto en la barra."
...
L["This lets you select the layout style of the auras area."] = "Aquí puedes seleccionar el diseño del estilo del área de auras"
...
L["This option allows you to control whether a cast's remaining cast time is hidden or shown on castbars."] = "Esta opción te permite controlar si el tiempo de lanzamiento restante de un lanzamiento se oculta o se muestra en las barras de lanzamiento."
...
L["This option allows you to control whether textures are hidden or shown on nameplates for different threat levels. Dps/healing uses regular textures, for tanking textures are swapped."] = "Esta opción le permite controlar si las texturas están ocultas o se muestran en las placas identificativas para diferentes niveles de amenaza. DPS / sanador usan texturas regulares, para tanques se intercambian las texturas."
...
L["This widget shows a unit's auras (buffs and debuffs) on its nameplate."] = "Este artilugio muestra las auras (beneficios y perjuicios) de una unidad en su placa identificativa."
L["This widget shows an experience bar for player followers."] = "Este artilugio muestra una barra de experiencia para los seguidores de los jugadores."
...
L["Threat Plates is currently maintained by Backup (CurseForge). It was originally written by Suicidal Katt (CurseForge)."] = "Threat Plates está actualmente mantenido por Backup (CurseForge). Fue escrito originalmente por Suicidal Katt (CurseForge)."
...
L["Threat Value Delta"] = "Valor delta de amenaza"
L["Three"] = "Tres"
...
L["Unit"] = "Unidad"
L["Unit (Names or NPC IDs)"] = "Unidad (Nombres o IDs)"
...
L["Use target scale and transparency settings also for soft enemy target."] = "Usar los valores de tamaño y transparencia también para objetivo dinámico enemigo."
L["Use target scale and transparency settings also for soft friend target."] = "Usar los valores de tamaño y transparencia también para objetivo dinámico aliado."
L["Use target scale and transparency settings also for soft interact target."] = "Usar los valores de tamaño y transparencia también para objetivo dinámico interactuable."
...
L["Word Wrap"] = "Espacio automático"
L["World Boss"] = "Jefe de mundo"
L["WoW Flat"] = "WoW Plano"
L["WoW Round"] = "WoW Redondo"
L["X"] = "X"
L["Y"] = "Y"

local L = LibStub("AceLocale-3.0"):NewLocale("TidyPlatesThreat", "itIT", false)
...
L[" The change will be applied after you leave combat."] = "La modifica verrà applicata dopo aver lasciato il combattimento."
--[[Translation missing --]]
L[" to DPS."] = " to DPS."
--[[Translation missing --]]
...
L["|cffff0000IMPORTANT: Enabling this feature changes console variables (CVars) which will change the appearance of default Blizzard nameplates. Disabling this feature will reset these CVars to the original value they had when you enabled this feature.|r"] = "|cffff0000IMPORTANTE: L'abilitazione di questa funzione modifica le variabili della console (CVars) che cambieranno l'aspetto delle targhette dei nomi Blizzard predefinite. La disabilitazione di questa funzione reimposterà questi CVar sul valore originale che avevano quando hai abilitato questa funzione.|r"
--[[Translation missing --]]

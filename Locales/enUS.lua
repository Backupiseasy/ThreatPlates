...
L["A custom nameplate with this trigger is already defined: %s. You cannot define two custom nameplates with the same trigger."] = true
L["A custom nameplate with this trigger is already defined: %s. You cannot use two custom nameplates with the same trigger."] = true
L["A to Z"] = true
L["About"] = true
...
L["Anchor Point"] = true
L["Appearance"] = true
L["Apply the custom settings to a nameplate when a particular aura is present on the unit."] = true
L["Apply the custom settings to a nameplate when a particular spell is cast by the unit."] = true
L["Arcane Mage"] = true
L["Arena 1"] = true
L["Arena 2"] = true
L["Arena 3"] = true
...
L["Export the current profile into a string that can be imported by other users."] = true
L["Faction Icon"] = true
L["Fading"] = true
L["Fanged Pit Viper"] = true
L["Filter by Spell"] = true
L["Filtered Auras"] = true
L["Find a suitable icon base on aura/spell ID or aura/spell name. This does not work for name-based custom nameplates."] = true
L["Five"] = true
L["Flash Time"] = true
...
L["Import a profile from a import string from another user."] = true
L["Import a profile"] = true
L["Import and export profiles that can be shared with other players."] = true
...
L["Social"] = true
L["Something went wrong with importing your profile. Please check the import string."] = true
L["Sort A-Z"] = true
L["Sort Order"] = true
L["Sort Z-A"] = true
...
L["Textures"] = true
L["The import string contains custom nameplate settings from an outdated Threat Plates version. Importing only works with data exported from the same Threat Plates version as you are using."] = true
L["The import string contains invaled custom nameplate settings and cannot be imported. Verify that the import string was generated from the same Threat Plates version that you are using."] = true
...
L["This option is disabled as you are still using legacy custom nameplates. Migrate your custom nameplates to the new version (using the Migration button at the top) to enable this option."] = true

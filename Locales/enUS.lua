...
L["All Auras"] = true
L["Always shows the full amount of absorbs on a unit. In overabsorp situations, the absorb bar ist shifted to the left."] = true
...
L["Headline View on Friendly Units in Combat"] = true
L["Headline View"] = true
L["Health Coloring"] = true
L["Health Text"] = true
L["Health"] = true
L["Healthbar Border"] = true
...
L["Legacy for Threat Plates defaults"] = true
L["Level Text"] = true
L["Level"] = true
L["Lich King"] = true
L["Living Ember"] = true
...
L["Non-Self Bottom Inset"] = true
L["Non-Self Top Inset"] = true
L["Non-Target"] = true
L["None"] = true
L["Normal Units"] = true
L["Note"] = true
...
L["Typeface"] = true
L["UI Scale"] = true
L["Unable to change a setting while in combat. The change will be applied after you leave combat."] = true
...
L["Use a striped texture for the absorb overlay. Always enabled if full absorbs are shown."] = true

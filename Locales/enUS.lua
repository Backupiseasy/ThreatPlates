...
L["Hide Unlimited"] = true
L["Hide buffs with unlimited duration."] = true
...
L["Paste"] = true
L["Pasted!"] = true
L["Paste ThreatPlates profile string into the box and then close the window"] = true
L["Percent Text"] = true

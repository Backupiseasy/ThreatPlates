...
L["This option is disabled as you are still using the obsolete custom nameplates format. Migrate your custom nameplates to the new format (using the Migration button at the top) to enable this option."] = true
...
L["You need to convert your custom nameplates to the current format before you can add legacy custom nameplates."] = true
...
L["|cffFF0000This option is disabled as you are still using the obsolete custom nameplates format. Migrate your custom nameplates to the new format (using the Migration button at the top) to enable this option.|r"] = true
L["|cffFFD100Current Instance:|r"] = true
L["|cffFFFFFFMigrate Custom Nameplates Settings|r"] = true

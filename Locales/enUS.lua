...
L[". You cannot define two custom nameplates with the same trigger."] = true
L["A custom nameplate with this trigger is already defined: "] = true
...
L["Export the current profile into text that can be pasted by another user"] = true
L["Faction Icon"] = true
L["Fading"] = true
...
L["Import a profile from another user"] = true
...
L["Overlapping"] = true
L["Paste Threat Plates profile string into the box and then close the window"] = true
L["Paste"] = true
L["Pasted!"] = true
...
L["Social"] = true
L["Something went wrong importing your profile, please check the import string."] = true
L["Sort A-Z"] = true
L["Sort Order"] = true
L["Sort Z-A"] = true

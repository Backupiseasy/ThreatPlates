...
---------------------------------------------------------------------------------------------------
L["  /tptpdps       Toggles DPS/Healing threat plates"] = true
L["  /tptpol        Toggles nameplate overlapping"] = true
L["  /tptptank      Toggles Tank threat plates"] = true
L["  /tptptoggle    Toggle Role from one to the other"] = true
L["  /tptpverbose   Toggles addon feedback text"] = true
L["  <no option>             Displays options dialog"] = true
L["  help                    Prints this help message"] = true
L["  legacy-custom-styles    Adds (legacy) default custom styles for nameplates that are deleted when migrating custom nameplates to the current format"] = true
L["  profile <name>          Switch the current profile to <name>"] = true
L["  toggle-scripting        Enable or disable scripting support (for beta testing)"] = true
...
L[". You cannot use two custom nameplates with the same trigger. The imported custom nameplate will be disabled."] = true
L["A custom nameplate with these triggers already exists: %s. You cannot use two custom nameplates with the same trigger. The current custom nameplate was therefore disabled."] = true
L["A custom nameplate with these triggers already exists: %s. You cannot use two custom nameplates with the same trigger."] = true
L["A custom nameplate with this trigger already exists: "] = true
L["A script has overwritten the global '%s'. This might affect other scripts ."] = true
L["A to Z"] = true
L["About"] = true
...
L["Adding legacy custom nameplate for %s ..."] = true
L["Additional Adjustments"] = true
L["Additional chat commands:"] = true
...
L["Animacharge"] = true
L["Appearance"] = true
L["Apply these custom settings to a nameplate when a particular spell is cast by the unit. You can add multiple entries separated by a semicolon"] = true
L["Apply these custom settings to the nameplate of a unit with a particular name. You can add multiple entries separated by a semicolon. You can use use * as wildcard character."] = true
L["Apply these custom settings to the nameplate when a particular aura is present on the unit. You can add multiple entries separated by a semicolon."] = true
L["Arcane Mage"] = true
L["Arena 1"] = true
L["Arena 2"] = true
L["Arena 3"] = true
...
L["Arrow"] = true
L["Art Options"] = true
L["Attempt to register script for unknown WoW event '%s'"] = true
L["Aura Icon"] = true
L["Aura"] = true
L["Aura: "] = true
L["Auras (Name or ID)"] = true
L["Auras"] = true
...
L["Cancel"] = true
L["Cast Target"] = true
L["Cast Time Alignment"] = true
L["Cast Time"] = true
L["Cast"] = true
L["Cast: "] = true
L["Castbar"] = true
L["Castbar, Healthbar"] = true
L["Center Auras"] = true
L["Center"] = true
...
L["Clamp Target Nameplate to Screen"] = true
L["Clamps the target's nameplate to the edges of the screen, even if the target is off-screen."] = true
L["Class Color for Players"] = true
L["Class Icon"] = true
L["Class"] = true
...
L["Curse"] = true
L["Custom Color"] = true
L["Custom Enemy Status Text"] = true
L["Custom Friendly Status Text"] = true
L["Custom Nameplates"] = true
L["Custom status text requires LibDogTag-3.0 to function."] = true
L["Custom status text requires LibDogTag-Unit-3.0 to function."] = true
L["Custom"] = true
L["DPS/Healing"] = true
L["Darnavan"] = true
...
L["Distance"] = true
L["Do not show buffs with unlimited duration."] = true
...
L["Enable Experience Widget"] = true
L["Enable Focus Widget"] = true
...
L["Enable this custom nameplate for friendly units."] = true
L["Enable this custom nameplate for neutral and hostile units."] = true
L["Enable this custom nameplate in instances."] = true
L["Enable this custom nameplate out of instances (in the wider game world)."] = true
...
L["Enemy Units"] = true
L["Enter an icon's name (with the *.blp ending), a spell ID, a spell name or a full icon path (using '\\' to separate directory folders)."] = true
L["Error in event script '%s' of custom style '%s': %s"] = true
L["Event Name"] = true
L["Events with Script"] = true
L["Everything"] = true
L["Exchange"] = true
L["Experience Text"] = true
L["Experience"] = true
L["Export Custom Nameplates"] = true
L["Export all custom nameplate settings as string."] = true
L["Export profile"] = true
L["Export the current profile into a string that can be imported by other players."] = true
L["Export"] = true
L["Extend"] = true
L["Faction Icon"] = true
L["Fading"] = true
L["Failed to migrate the imported profile to the current settings format because of an internal error. Please report this issue at the Threat Plates homepage at CurseForge: "] = true
L["Fanged Pit Viper"] = true
L["Filter by Spell"] = true
L["Filtered Auras"] = true
L["Find a suitable icon based on the current trigger. For Name trigger, the preview does not work. For multi-value triggers, the preview always is the icon of the first trigger entered."] = true
L["Five"] = true
L["Flash Time"] = true
...
L["Font Size"] = true
L["Font"] = true
L["Forbidden function or table called from script: %s"] = true
...
L["Illegal character used in Name trigger at position: "] = true
L["Immortal Guardian"] = true
L["Import Custom Nameplates"] = true
L["Import a profile from another player from an import string."] = true
L["Import and export profiles to share them with other players."] = true
L["Import custom nameplate settings from a string. The custom namneplates will be added to your current custom nameplates."] = true
L["Import profile"] = true
L["Import/Export Profile"] = true
L["In Combat"] = true
L["In Instances"] = true
...
L["Insert a new custom nameplate slot after the currently selected slot."] = true
L["Inset"] = true
L["Insets"] = true
L["Inside"] = true
L["Instance IDs"] = true
...
L["Only for Target"] = true
L["Only in Instances"] = true
L["Onyxian Whelp"] = true
L["Open Blizzard Settings"] = true
L["Open Options"] = true
L["Orbs"] = true
L["Out Of Instances"] = true
L["Out of Combat"] = true
L["Outline"] = true
L["Outline, Monochrome"] = true
L["Overlapping"] = true
L["Paladin"] = true
L["Paste the Threat Plates profile string into the text field below and then close the window"] = true
L["Paste"] = true
...
L["Same as Bar Foreground"] = true
L["Same as Foreground"] = true
L["Same as Name"] = true
L["Scale"] = true
L["Scriping for custom styles for nameplates is now |cff00ff00enabled!|r."] = true
L["Scriping for custom styles for nameplates is now |cffff0000disabled!|r."] = true
L["Script"] = true
L["Scripts"] = true
L["Set Icon"] = true
...
L["Shows a glow effect on this custom nameplate."] = true
...
L["Spell Icon"] = true
L["Spell Name Alignment"] = true
L["Spell Name"] = true
L["Spell Text Boundaries"] = true
L["Spell Text"] = true
L["Spells (Name or ID)"] = true
L["Spirit Wolf"] = true
L["Square"] = true
L["Squares"] = true
L["Stack Count"] = true
...
L["Stripes"] = true
L["Style"] = true
L["Supports multiple entries, separated by commas."] = true
L["Swap By Reaction"] = true
L["Switch scale values for debuffs and buffs for friendly units."] = true
L["Symbol"] = true
L["Syntax error in event script '%s' of custom style '%s': %s"] = true
L["Tank"] = true
L["Tapped Units"] = true
L["Tapped"] = true
L["Target Hightlight"] = true
...
L["Texture"] = true
L["Textures"] = true
L["The import string contains a profile from an different Threat Plates version. The profile will still be imported (and migrated as far as possible), but some settings from the imported profile might be lost."] = true
L["The import string contains custom nameplate settings from a different Threat Plates version. The custom nameplates will still be imported (and migrated as far as possible), but some settings from the imported custom nameplates might be lost."] = true
L["The import string has an invalid format and cannot be imported. Verify that the import string was generated from the same Threat Plates version that you are using currently."] = true
L["The import string has an unknown format and cannot be imported. Verify that the import string was generated from the same Threat Plates version that you are using currently."] = true
...
L["The script has overwritten the global '%s', this might affect other scripts ."] = true
...
L["This option allows you to control whether a cast's remaining cast time is hidden or shown on castbars."] = true
...
L["This widget highlights the nameplate of your current focus target by showing a border around the healthbar and by coloring the nameplate's healtbar and/or name with a custom color."] = true
...
L["This widget shows an experience bar for player followers."] = true
...
L["Threat Glow"] = true
L["Threat Plates Script Editor"] = true
...
L["Use a custom color for the background."] = true
L["Use a custom color for the bar background."] = true
L["Use a custom color for the bar's border."] = true
...
L["Use a custom color for the healthbar of your current focus target."] = true
L["Use a custom color for the healthbar of your current target."] = true
L["Use a custom color for the name of your current focus target (in healthbar view and in headline view)."] = true
...
L["Use the background color also for the border."] = true
L["Use the bar foreground color also for the background."] = true
L["Use the bar foreground color also for the bar background."] = true
L["Use the bar foreground color also for the border."] = true
...
L["Your version of LibDogTag-Unit-3.0 does not support nameplates. You need to install at least v90000.3 of LibDogTag-Unit-3.0."] = true
...
L["|cff89F559Threat Plates|r: No profile specified"] = true
...
L["|cff89F559Threat Plates|r: Unknown profile: "] = true
...
L["|cffFF0000The Auras widget must be enabled (see Widgets - Auras) to use auras as trigger for custom nameplates.|r"] = true
L["|cffFFD100Current Instance:|r"] = true

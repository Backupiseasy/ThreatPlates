...
L["Export the current profile into text that can be pasted by another user"] = "다른 사용자가 붙여 넣을 수있는 텍스트로 현재 프로파일 내보내기"
...
L["Import a profile"] = "프로필 가져 오기"
L["Import a profile from another user"] = "다른 사용자의 프로필 가져 오기"
L["Import and export profiles that can be shared with other players"] = "다른 플레이어와 공유 할 수있는 프로파일 가져 오기 및 내보내기"
L["Import/Export Profile"] = "프로필 가져 오기 / 내보내기"
...
L["Paste"] = "붙여넣기"
L["Pasted!"] = "붙여넣었습니다!"
L["Paste ThreatPlates profile string into the box and then close the window"] = "프로필 문자열을 상자에 붙여 넣은 다음 창을 닫습니다."
...
L["Skull Icon"] = "해골 아이콘"
L["Social"] = "소셜"
L["Something went wrong importing your profile, please check the import string"] = "프로필 가져 오기가 잘못되었습니다. 가져 오기 문자열을 확인하십시오."

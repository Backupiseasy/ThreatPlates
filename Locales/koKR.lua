...
--Translation missing
L["  8.4-design         Changes default settings to new look and feel (introduced with 8.4)"] = "  8.4-design         Changes default settings to new look and feel (introduced with 8.4)"
--Translation missing
L["  classic-design     Reverts default settings back to look and feel before 8.4"] = "  classic-design     Reverts default settings back to look and feel before 8.4"
...
--Translation missing
L["Changing default settings to updated look and feel introduced with 8.4 ..."] = "Changing default settings to updated look and feel introduced with 8.4 ..."
...
L["Color Healthbar By Friendly Class"] = "우호적 직업 별 생명력바 색상"
...
--Translation missing
L["Define a custom alpha for this nameplate and overwrite any other alpha settings."] = "Define a custom alpha for this nameplate and overwrite any other alpha settings."
--Translation missing
...
L["Disables nameplates (healthbar and name) for the units of this type and only shows an icon (if enabled)."] = "이 유형의 유닛의 이름표 (생명력바와 이름)를 비활성하고 아이콘만 표시합니다 (사용할때만)."
...
L["Do not sort auras."] = "오라를 정렬하지 않습니다."
--Translation missing
L["Don't Switch"] = "Don't Switch"
...
--Translation missing
L["Enable Custom Alpha"] = "Enable Custom Alpha"
--Translation missing
L["Enable Custom Color"] = "Enable Custom Color"
L["Enable Custom Colors"] = "사용자 설정 색상 사용"
--Translation missing
L["Enable Custom Scale"] = "Enable Custom Scale"
L["Enable Enemy"] = "적 사용"
L["Enable Friendly"] = "우호적 사용"
L["Enable Friends"] = "아군 사용"
...
L["Enable nameplate clickthrough for friendly units."] = "우호적 유닛의 이름표에 클릭 무시를 사용합니다."
...
--Translation missing
L["Enabled Threat Glow"] = "Enabled Threat Glow"
...
L["Friendly Custom Text"] = "우호적 사용자 설정 문자"
L["Friendly Headline Color"] = "우호적 헤드라인 색상"
...
L["If enabled your nameplates alpha will always be the setting below when you have no target."] = "활성화하면 대상이 없을 때 아래 설정으로 이름표 투명도가 변경됩니다."
L["If enabled your nameplates scale will always be the setting below when you have no target."] = "활성화하면 대상이 없을 때 아래 설정으로 이름표 크기 비율이 변경됩니다."
...
--Translation missing
L["In combat, use alpha based on threat level as configured in the threat system. The custom alpha is only used out of combat."] = "In combat, use alpha based on threat level as configured in the threat system. The custom alpha is only used out of combat."
--Translation missing
L["In combat, use coloring based on threat level as configured in the threat system. The custom color is only used out of combat."] = "In combat, use coloring based on threat level as configured in the threat system. The custom color is only used out of combat."
--Translation missing
L["In combat, use coloring, alpha, and scaling based on threat level as configured in the threat system. Custom settings are only used out of combat."] = "In combat, use coloring, alpha, and scaling based on threat level as configured in the threat system. Custom settings are only used out of combat."
--Translation missing
L["In combat, use scaling based on threat level as configured in the threat system. The custom scale is only used out of combat."] = "In combat, use scaling based on threat level as configured in the threat system. The custom scale is only used out of combat."
...
L["Shows resource information only for alternatve power (of bosses or rares, mostly)."] = "보조 자원의 자원 정보만 표시합니다 (대부분 우두머리 또는 희귀의)."
L["Size"] = "크기"
L["Sizing"] = "크기 조절"
L["Skull Icon"] = "해골 아이콘"
L["Social"] = "소셜"
...
--Translation missing
L["This option allows you to control whether custom settings for nameplate style, color, alpha and scaling should be used for this nameplate."] = "This option allows you to control whether custom settings for nameplate style, color, alpha and scaling should be used for this nameplate."
...
L["This widget shows a unit's auras (buffs and debuffs) on its nameplate."] = "이름표에 유닛의 오라(강화 효과와 약화 효과)를 표시하는 장치입니다."
...
L["Use scaling settings of healthbar view also to headline view."] = "생명력바 보기의 크기 비율 설정을 헤드라인 보기에도 사용합니다."
...
--Translation missing
L["Use Threat Alpha"] = "Use Threat Alpha"
--Translation missing
L["Use Threat Coloring"] = "Use Threat Coloring"
L["Use Threat Colors"] = "위협 수준 색상 사용"
--Translation missing
L["Use Threat Scale"] = "Use Threat Scale"

...
L["Export the current profile into text that can be pasted by another user"] = "將當前配置文件導出為可由其他用戶粘貼的文本"
L["Faction Icon"] = "陣營圖示"
L["Fading"] = "淡出"
...
L["Import a profile"] = "導入個人資料"
L["Import a profile from another user"] = "從其他用戶導入配置文件"
L["Import and export profiles that can be shared with other players"] = "導入和導出可與其他玩家共享的配置文件"
L["Import/Export Profile"] = "導入/導出配置文件"
...
L["Paste"] = "貼上"
L["Pasted!"] = "已貼上!"
L["Paste ThreatPlates profile string into the box and then close the window"] = "將配置文件字符串粘貼到框中，然後關閉窗口"
...
L["Show the amount you need to loot or kill"] = "顯示掠奪或殺戮所需的金額"
...
L["Social"] = "社交"
L["Something went wrong importing your profile, please check the import string"] = "導入個人資料時出錯，請檢查導入字符串"

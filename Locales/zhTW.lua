...
L["Changing these options may interfere with other nameplate addons or Blizzard default nameplates as console variables (CVars) are changed."] = "更改這些選項可能會影響其他血條插件或遊戲內建的名條，讓使用到遊戲控制參數 (CVars) 的設定一併變更。"
...
L["Enable Healer Tracker"] = "啟用治療師跟踪器"
...
L["Hide the Blizzard default nameplates for friendly units in instances."] = "副本中隱藏遊戲內建的友方名條。"
L["High Threat"] = "高仇恨值"
...
L["This widget shows players that are healers."] = "這個小部件顯示了作為治療師的玩家。"

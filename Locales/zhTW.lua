...
L["Always"] = "永遠顯示"
L["Always show buffs with unlimited duration."] = "永遠顯示沒有時間限制的增益效果。"
L["Always shows the full amount of absorbs on a unit. In overabsorb situations, the absorbs bar ist shifted to the left."] = "永遠顯示單位的吸收盾總量。在過度吸收的情況下，吸收條會向左移動。"
L["Always shows the full amount of absorbs on a unit. In overabsorp situations, the absorb bar ist shifted to the left."] = "永遠顯示單位的吸收盾總量。在過度吸收的情況下，吸收條會向左移動。"
L["Amount"] = "數值"
L["Amount Text"] = "數值文字"

...
L["This settings changes CVars related to soft target and are not stored in the profile, but by WoW itself (character-specific settings)."] = "此設定會更改軟目標相關的 CVars 遊戲參數，會儲存在遊戲本身 (角色專用設定) 而不是儲存在設定檔。"

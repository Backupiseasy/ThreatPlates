...
L["A script has overwritten the global '%s'. This might affect other scripts."] = "一個腳本覆寫了全域變數 '%s'，這可能會影響其他腳本。"
L["A to Z"] = "A 到 Z"
L["Abbreviation"] = "縮寫"
L["About"] = "關於"
L["Absorbs"] = "吸收盾"
...
L["Always shows the full amount of absorbs on a unit. In overabsorb situations, the absorbs bar is shifted to the left."] = "一律顯示單位身上完整的吸收量。在吸收過量的情況下，吸收條會向左偏移。"
L["Amount"] = "數值"
L["Anchor"] = "對齊"
L["Anchor Point"] = "對齊點"
L["Anchor to"] = "對齊到"
...
L["Apply these custom settings to the nameplate of a unit with a particular name or NPC ID. You can add multiple entries separated by a semicolon. You can use * as wildcard character in names."] = "將這些自訂設定套用到特定名稱或 NPC ID 單位的血條上。可以新增多筆項目，並以分號分隔。名稱中可以使用 * 作為萬用字元。"
...
L["Big"] = "大型"
L["Big matches the previous default size; normal keeps nameplates more compact, scaled down by the UI scale."] = "「大型」符合先前的預設大小；「一般」則讓姓名板維持較精簡的尺寸，並依 UI 縮放比例縮小。"
L["Blizzard"] = "暴雪"
...
L["Changes the default settings to the selected design. Some of your custom settings may get overwritten if you switch back and forth."] = "改變預設設定為所選的樣式。若在不同樣式間來回切換，部分自訂設定可能會被覆寫。"
...
L["Darnavan"] = "達納凡"
L["Death Knight"] = "死亡騎士"
L["Death Knight Rune Cooldown"] = "死亡騎士符文冷卻"
L["Death Rune"] = "死亡符文"
L["Debuff Color"] = "減益顏色"
L["Debuffs"] = "減益"
...
L["Enable this if you want to show Blizzard's special resources above the target nameplate."] = "若您想在目標血條上方顯示暴雪的特殊資源，請啟用此選項。"
...
L["Import custom nameplate settings from a string. The custom nameplates will be added to your current custom nameplates."] = "從字串匯入自訂血條設定。這些自訂血條將會加入到您目前的自訂血條中。"
...
L["Show crowd control auras that were applied by bosses."] = "顯示由首領施加的控場效果。"
...
L["Show debuffs that were applied by bosses."] = "顯示由首領施加的減益效果。"
...
L["Shows resource information only for alternative power (of bosses or rares, mostly)."] = "僅顯示額外能量資源資訊（主要用於首領或稀有怪物）。"
L["Shows the name of the player that interrupted the spell."] = "顯示打斷該法術的玩家名稱。"
...
L["This widget highlights the nameplate of your current focus target by showing a border around the healthbar and by coloring the nameplate's healthbar and/or name with a custom color."] = "此元件會透過在血量條周圍顯示邊框，以及以自訂顏色為名條的血量條和/或名稱上色，來標示您目前專注目標的名條。"
L["This widget highlights the nameplate of your current target by showing a border around the healthbar and by coloring the nameplate's healthbar and/or name with a custom color."] = "此元件會透過在血量條周圍顯示邊框，以及以自訂顏色為名條的血量條和/或名稱上色，來標示您目前目標的名條。"
...
L["Unable to change this setting while in combat"] = "戰鬥中無法變更此設定"
L["Unfriendly"] = "不友好"
...
L["Use threat scale as additive scale and add or subtract it from the general scale settings."] = "將威脅值縮放大小視為附加縮放大小，並將其與一般縮放大小設定相加或相減。"
L["Use threat transparency as additive transparency and add or subtract it from the general transparency settings."] = "將威脅值透明度視為附加透明度，並將其與一般透明度設定相加或相減。"

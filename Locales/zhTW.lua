...
L["This option allows you to control whether custom settings for nameplate style, color, transparency and scaling should be used for this nameplate."] = "這個選項讓你可以控制要如何自訂這個血條的樣式、顏色、透明度和縮放大小。"
...
L["This option allows you to control whether threat affects the transparency of nameplates."] = "這個選項讓你可以控制仇恨值是否要影響血條的透明度。"

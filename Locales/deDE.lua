...
L["By Health"] = "Gesundheit"
L["By Reaction"] = "Reaktion"
...
L["Export the current profile into text that can be pasted by another user"] = "Exportieren Sie das aktuelle Profil in Text, den ein anderer Benutzer einfügen kann"
...
L["Hide buffs with unlimited duration."] = "Verstecke Buffs mit unendlicher Laufzeit."
...
L["Import a profile from another user"] = "Importieren Sie ein Profil von einem anderen Benutzer"
L["Import and export profiles that can be shared with other players"] = "Importieren und Exportieren von Profilen, die für andere Spieler freigegeben werden können"
...
L["Paste"] = "Einfügen"
L["Pasted!"] = "-Eingefügt!"
L["Paste ThreatPlates profile string into the box and then close the window"] = "Fügen Sie die ThreatPlates-Profilzeichenfolge in das Feld ein und schließen Sie das Fenster"
...
L["Quest Progress"] = "Zeige Details der Quest"
...
L["Show the amount you need to loot or kill"] = "Zeige die Menge, die du plündern oder töten musst"
...
L["Something went wrong importing your profile, please check the import string"] = "Beim Importieren Ihres Profils ist ein Fehler aufgetreten. Überprüfen Sie die Importzeichenfolge"

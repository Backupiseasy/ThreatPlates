...
function Widget:UpdateSettings()
  ...
  elseif PlayerClass == "ROGUE" then
    ...
    if name and GetSpellInfo(name) then
      ...
      script_texture_info["ComboPoint.Charged.On"]  = Addon:GetIconTexture("ComboPoint.Charged.On")
      script_texture_info["ComboPoint.Charged.Off"] = Addon:GetIconTexture("ComboPoint.Charged.Off")
      script_texture_info.IsEnabled = script_texture_info.IsEnabled and script_texture_info["ComboPoint.Charged.On"] ~= nil and script_texture_info["ComboPoint.Charged.Off"] ~= nil

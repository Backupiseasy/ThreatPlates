...
Addon.DEFAULT_SETTINGS = {
  ...
  profile = {
    ...
    Visibility = {
      ...
      FriendlyNPC = { Show = (Addon.HAS_MIDNIGHT_API and "nameplateShowFriendlyNpcs") or "nameplateShowFriendlyNPCs", UseHeadlineView = false },
      FriendlyMinion = { Show = (Addon.HAS_MIDNIGHT_API and "nameplateShowFriendlyPlayerMinions") or "nameplateShowFriendlyMinions", UseHeadlineView = false },
      FriendlyPet = { Show = (Addon.HAS_MIDNIGHT_API and "nameplateShowFriendlyPlayerPets") or "nameplateShowFriendlyPets", UseHeadlineView = false },
      FriendlyGuardian = { Show = (Addon.HAS_MIDNIGHT_API and "nameplateShowFriendlyPlayerGuardians") or "nameplateShowFriendlyGuardians", UseHeadlineView = false },
      FriendlyTotem = { Show = (Addon.HAS_MIDNIGHT_API and "nameplateShowFriendlyPlayerTotems") or "nameplateShowFriendlyTotems", UseHeadlineView = false },

      ...
      Clickthrough = {
        ...
        args = {
          ClickthroughFriendly = {
            ...
            width = "double",
            set = function(info, val)
              t.SetNamePlateClickThrough(val, db.NamePlateEnemyClickThrough)
            end,
          ...
          ClickthroughEnemy = {
            ...
            width = "double",
            set = function(info, val)
              t.SetNamePlateClickThrough(db.NamePlateFriendlyClickThrough, val)
            end,
                ...
                Friends = {
                  ...
                  args = {
                    ...
                    ModeHealthBar = {
                      ...
                      inline = true,
                      args = {
                        Help = { type = "description", order = 0,	width = "full",	name = L["Use a custom color for the healthbar (in healthbar view) or the name text (in headline view) of friends and/or guild members."],	},
                        EnableFriends = {
            ...
            HealthColor = {
              ...
              args = {
                UseRaidMarked = {
                  name = L["Color by Raid Marks"],
                  type = "toggle",
                  desc = L["Additionally color the nameplate's healthbar or name based on the raid mark if the unit is marked."],
                  descStyle = "inline",
                  width = "full",
                  order = 1,

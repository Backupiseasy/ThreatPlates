...
--             },
  ...
  if Addon.ExpansionIsAtLeastTBC or Addon.IS_CLASSIC_SOD or (C_Seasons and C_Seasons.GetActiveSeason() == 11) or (C_Seasons and C_Seasons.GetActiveSeason() == 12) then
    if LibDualSpec then

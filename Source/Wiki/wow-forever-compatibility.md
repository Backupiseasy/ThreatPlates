...
| Friendly pets / totems get no nameplate while friendly players are disabled (fix #34) | ✅ confirmed |
| Friendly guardians get no nameplate while friendly players are disabled (fix #34; option disabled based on assumption, not individually verified) | ⏳ open |
